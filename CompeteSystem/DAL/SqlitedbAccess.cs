...
namespace CompeteSystem.DAL
{
    public class SqliteDbAccess
    {
        public static SQLiteConnection ConStr=new SQLiteConnection($"Data Source={Application.StartupPath}\\db\\CompeteSystemDM.db;Version=3 ;UTF8Encoding=True;");
